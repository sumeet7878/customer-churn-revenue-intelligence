  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Footer */}
        <footer className="mt-8 flex flex-wrap items-center justify-center gap-2 text-center text-gray-600 text-xs">
          <span>Model: {data.model_name} (ROC-AUC {data.auc}) · Dataset: IBM Telco Customer Churn</span>
